...
const BUILT_IN_LOCALE_EXAMPLE_COMMENT = "Generated built-in locale example. It is overwritten on every launcher start; do not edit this file directly. Copy it to a different file to create a custom translation.";
...
function toBuiltInLocaleExampleFile(locale: LoadedLocale): LocaleFile & { __comment: string } {
    return {
...
function isBuiltInLocaleExampleFile(value: unknown): boolean {
