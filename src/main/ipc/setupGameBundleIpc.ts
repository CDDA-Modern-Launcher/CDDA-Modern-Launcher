...
export function setupGameBundleIpc(gameBundleService: GameBundleService): void {
    ...
    ipcMain.handle(Bridge.Game.openGameBundleFolder, async (_event, gameBundleId: string): Promise<EGameFolderOpenResult> => openFolder(await gameBundleService.getGameBundleFolder(gameBundleId)));
    ipcMain.handle(Bridge.Game.openSavesFolder, async (_event, gameBundleId: string): Promise<EGameFolderOpenResult> => openFolder(await gameBundleService.getSavesFolder(gameBundleId)));
